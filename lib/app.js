...
document.gignal.views.TextBox = (function(_super) {
  ...
  TextBox.prototype.re_links = /((http|https)\:\/\/[a-zA-Z0-9\-\.]+\.[a-zA-Z]{2,3}(\/\S*)?)/g;
  ...
  TextBox.prototype.render = function() {
    ...
    this.$el.html(Templates.post.render({
      message: text,
      username: username,
      ...
      user_image: this.model.get('user_image')
    }));
    return this;
  };
...
document.gignal.views.PhotoBox = (function(_super) {
  ...
  PhotoBox.prototype.render = function() {
    ...
    this.$el.html(Templates.photo.render({
      message: text,
      username: username,
      name: this.model.get('name'),
      creation: this.model.get('creation'),
      ...
      service: this.model.get('service'),
      user_image: this.model.get('user_image'),
      thumb_photo: this.model.get('thumb_photo')
    }));
    return this;
  };
