...
Stream = (function(_super) {
  ...
  Stream.prototype.inset = function(model) {
    ...
    return document.gignal.widget.$el[method](view.render().el).isotope('reloadItems').isotope({
  ...
  Stream.prototype.update = function(append) {
    var limit, sinceTime, sinceTimeCall,
      _this = this;
    this.append = append;
    if (this.calling) {
      return;
    ...
    if (!this.append) {
      ...
      this.parameters.limitMore += this.parameters.limit;
      limit = this.parameters.limitMore;
    }
    ...
    return this.fetch({
      ...
      data: {
        limit: limit,
        sinceTime: sinceTime > 0 ? sinceTime : void 0,
